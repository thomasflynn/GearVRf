 ...
 */
class MonoscopicVrapiActivityHandler implements MonoscopicActivityHandler {
    ...
    private MonoscopicViewManager mViewManager;
    private int mCurrentSurfaceWidth, mCurrentSurfaceHeight;
    private boolean mVrApiInitialized;

    MonoscopicVrapiActivityHandler(final GVRActivity activity, final MonoscopicActivityNative activityNative) {
        if (null == activity) {
    ...
    public void setViewManager(GVRViewManager viewManager) {
        mViewManager = (MonoscopicViewManager)viewManager;
    }
    ...
    private static final String TAG = "MonoscopicVrapiActivityHandler";
}
